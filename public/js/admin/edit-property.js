var option_str_property_type = document.getElementById("property-type");
var option_str_action_type = document.getElementById("action-type");
var option_str_state = document.getElementById("state");
var option_str_furnished = document.getElementById("furnished");
...
document.getElementById('property-availabity').valueAsDate = new Date(date);


var action_type_arr = new Array('Sale', 'Rent', 'PG');
var property_type_arr = new Array('House', 'Apaertment/Flat', 'Villa', 'Builder FLoor', 'Farm House', 'Retail Shop', 'Retail Showroom', 'Commercial Building', 'Office/Offoce Space', 'IT/Software Technology Park', 'Warehouse', 'Hotel', 'Industrial Building', 'Industrial Estate', 'Industrial Shed');
var state_arr = new Array("Andaman & Nicobar", "Andhra Pradesh", "Arunachal Pradesh", "Assam", "Bihar", "Chandigarh", "Chhattisgarh", "Dadra & Nagar Haveli", "Daman & Diu", "Delhi", "Goa", "Gujarat", "Haryana", "Himachal Pradesh", "Jammu & Kashmir", "Jharkhand", "Karnataka", "Kerala", "Lakshadweep", "Madhya Pradesh", "Maharashtra", "Manipur", "Meghalaya", "Mizoram", "Nagaland", "Orissa", "Pondicherry", "Punjab", "Rajasthan", "Sikkim", "Tamil Nadu", "Tripura", "Uttar Pradesh", "Uttaranchal", "West Bengal");
var furnished_arr = new Array('Furnished', 'Semi-Furnished', 'Unfurnushed')
var facing_arr = new Array('East', 'North', 'North-East', 'North-West', 'South', 'South-East', 'South-Wedt', 'Weat')
var transactional_type_arr = new Array('New Property', 'Resale Property')
var property_ownership_arr = new Array('Builder', 'Individually Owned', 'Jointly Owned', 'Co-operative Housing Society', 'Other')
...
setOption(option_str_state, state_arr);
setOption(option_str_action_type, action_type_arr);
setOption(option_str_property_type, property_type_arr);
setOption(option_str_furnished, furnished_arr)
setOption(option_str_facing, facing_arr)
setOption(option_str_transactional_type, transactional_type_arr)
setOption(option_str_property_ownership, property_ownership_arr)


function print_city(city_id, city_index) {
    var option_str = document.getElementById(city_id);
    var city_arr = s_a[city_index].split("|");
    setOption(option_str, city_arr);
}

function setOption(option_str, option_arr) {
    option_str.length = 1;
    // option_str.options[1] = new Option('Select', '');
    option_str.selectedIndex = 0;
    for (var i = 0; i < option_arr.length; i++) {
        option_str.options[option_str.length] = new Option(option_arr[i], option_arr[i]);
    }
}
...
function toggle(value, options) {
    options.forEach(option => {
        document.getElementById(option).addEventListener("click", function (index) {
            for (var j = 0; j < options.length; j++) {
                document.getElementById(options[j]).classList.remove("active");
            }
